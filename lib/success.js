...
function Success(result, message, code) {
    ...
    message:        { value: message || success[200].message, enumerable: true },
    result:         { value: result, enumerable: true },
    httpEquivelant: { value: code || success[200].code },
    headers:        { value: {} }
...
Object.defineProperties(Success.prototype, {
	...
	toString : {
		value: function() {
			...
			, res = successPreamble.concat(this.httpEquivelant, ' - ', this.message);
			;
...
Object.defineProperties(ResourceError, {
	...
	created:          {
		value: function(result, location) {
			...
			if (location) {
				res.addHeaders({ location: location });
			}
			return res;
  	}, enumerable: true
  },
